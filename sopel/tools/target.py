...
class Channel(object):
    ...
    def is_oper(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.OPER)
    ...
    def is_owner(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.OWNER)
    ...
    def is_admin(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.ADMIN)
    ...
    def is_op(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.OP)
    ...
    def is_halfop(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.HALFOP)
    ...
    def is_voiced(self, nick):
        ...
        """
        return bool(self.privileges.get(Identifier(nick), 0) & plugin.VOICE)
